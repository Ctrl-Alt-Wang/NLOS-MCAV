...
from model.r2unet_swin_fft_GLU import R2U_Net
...
parser.add_argument('--datarootValData', default="Data/SuperModel/valid/blur")
parser.add_argument('--datarootValTarget', default="Data/SuperModel/valid/sharp")
parser.add_argument('--datarootTestData', default="Data/SuperModel/train/blur")
parser.add_argument('--datarootTestTarget', default="Data/SuperModel/train/sharp")


parser.add_argument('--epoches',type=int,default=10000)
parser.add_argument('--batchsize',type=int,default=1)
parser.add_argument('--num_workers',type=int,default=0)
parser.add_argument('--name',type=str,default='NLOS-ST_SuperModel')
parser.add_argument('--model_name',type=str,default='SuperModel')
...
parser.add_argument('--test_checkpoints_load_dir', type=str, default='./checkpoints/NLOS-ST_SuperModel/')
...
if __name__ == '__main__':
    ...
    all_imgs_path_test = glob.glob(args.datarootTestData + '/*.png')
    all_target_path_test = glob.glob(args.datarootTestTarget + '/*.png')
    ...
    print("Number of images in validation data:", len(all_imgs_path_test))
    print("Number of target images in validation data:", len(all_target_path_test))
