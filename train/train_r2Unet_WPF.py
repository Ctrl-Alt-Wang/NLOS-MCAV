...
parser.add_argument('--datarootData', default="Data/MY1500/train/BR") 
parser.add_argument('--datarootTarget', default="Data/MY1500/train/GT")
parser.add_argument('--datarootValData', default="Data/MY1500/test/BR")
parser.add_argument('--datarootValTarget', default="Data/MY1500/test/GT")
parser.add_argument('--datarootTestData', default="Data/MY1500/test/BR")
parser.add_argument('--datarootTestTarget', default="Data/MY1500/test/GT")
...
parser.add_argument('--name',type=str,default='NLOS-ST_MY')#最后一个"_"后要写模型名
