...
####################################public data carton###########################
parser.add_argument('--datarootData', default=r"E:\ZiLiao\IVF\train\vis\BR")
parser.add_argument('--datarootTarget', default=r"E:\ZiLiao\IVF\train\vis\GT")
parser.add_argument('--datarootValData', default=r"E:\ZiLiao\IVF\test\vis_test\BR")
parser.add_argument('--datarootValTarget', default=r"E:\ZiLiao\IVF\test\vis_test\GT")
parser.add_argument('--datarootTestData', default=r"E:\ZiLiao\IVF\test\vis_test\BR")
parser.add_argument('--datarootTestTarget', default=r"E:\ZiLiao\IVF\test\vis_test\GT")

parser.add_argument('--epoches',type=int,default=200)
parser.add_argument('--batchsize',type=int,default=1)
parser.add_argument('--num_workers',type=int,default=0)
parser.add_argument('--name',type=str,default='HGSRCNN')#最后一个"_"后要写模型名
