...
from model.r2unet_swin_fft_GLU import R2U_Net#改完模型记得改模型存储路径
...
from loss.ssim import CharbonnierLoss
...
#####################################public data carton###########################
# parser.add_argument('--datarootData', default=r"E:\ZiLiao\wb256\train\input")
# parser.add_argument('--datarootTarget', default=r"E:\ZiLiao\wb256\train\groundtruth")
# parser.add_argument('--datarootValData', default=r"E:\ZiLiao\wb256\test\input")
# parser.add_argument('--datarootValTarget', default=r"E:\ZiLiao\wb256\test\groundtruth")
# parser.add_argument('--datarootTestData', default=r"E:\ZiLiao\wb256\test\input")
# parser.add_argument('--datarootTestTarget', default=r"E:\ZiLiao\wb256\test\groundtruth")
...
parser.add_argument('--datarootData', default="Data/SuperModel/train/blur") 
parser.add_argument('--datarootTarget', default="Data/SuperModel/train/sharp")
parser.add_argument('--datarootValData', default="Data/SuperModel/test/blur")
parser.add_argument('--datarootValTarget', default="Data/SuperModel/test/sharp")
parser.add_argument('--datarootTestData', default="Data/SuperModel/test/blur")
parser.add_argument('--datarootTestTarget', default="Data/SuperModel/test/sharp")

parser.add_argument('--epoches',type=int,default=300)
parser.add_argument('--batchsize',type=int,default=1)
parser.add_argument('--num_workers',type=int,default=0)
parser.add_argument('--name',type=str,default='NLOS-ST_SuperModel')#最后一个"_"后要写模型名
